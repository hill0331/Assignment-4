...
//	Purpose:		Victory Screen Screen Code
...
#include "Buttons/VictoryScreenButtonGroup.h"
...
VictoryScreen::VictoryScreen()
{
	...
	m_TitleTex = new OpenGLTexture(VICTORY_SCREEN_TITLE_TEXTURE);

	m_Buttons = new VictoryScreenButtonGroup();
	m_CurrentAlpha = 1;
...
void VictoryScreen::update(double delta)
{
...
void VictoryScreen::mouseMovementEvent(float deltaX, float deltaY, float positionX, float positionY)
{
	if (m_Buttons != NULL)
	{
...
void VictoryScreen::mouseLeftClickDownEvent(float positionX, float positionY)
{
	if (m_Buttons != NULL)
	{
...
void VictoryScreen::mouseRightClickDownEvent(float positionX, float positionY)
{
...
void VictoryScreen::mouseLeftClickUpEvent(float positionX, float positionY)
{
...
void VictoryScreen::mouseRightClickUpEvent(float positionX, float positionY)
{
...
void VictoryScreen::keyDownEvent(int keyCode)
{
	if (m_Buttons != NULL)
	{
...
void VictoryScreen::keyUpEvent(int keyCode)
{
...
void VictoryScreen::transitionOut(const char* screenName)
{
	ScreenManager::getInstance()->switchScreen(screenName);
}

void VictoryScreen::buttonPressed(int buttonNumber)
{
	if (buttonNumber == 0)
	{
